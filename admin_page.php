...
<link href="https://fonts.googleapis.com/css?family=Nanum+Gothic|Roboto:300,400&display=swap" rel="stylesheet"> 	<script language=javascript>
...
<div class="row">
  <div class="text_column"> 
    <center><h2 style = "color: black;">ATTENDANCE</h2></center>
  </div>
  <div class="text_column">
    <center><h2 style = "color: black;">OFFICE HOURS</h2></center>
  </div>
</div>
  ...
  <div class="column">
	...
	echo"<table>
		<thead>
			<tr>
				<th>SIL</th>
				<th style = 'float:right;'>ATTENDANCE<br /> REPORTED</th> 
			</tr>
		</thead>";
